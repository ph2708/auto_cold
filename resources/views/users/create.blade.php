...
<div class="max-w-2xl mx-auto">
    <div class="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 sm:p-8">
        ...
        <div class="flex items-center justify-between pb-6 mb-6 border-b border-slate-800">
            <div>
                <h3 class="text-base font-bold text-white font-heading">Novo Acesso de Usuário</h3>
                <p class="text-xs text-slate-400">Defina os dados, login, perfil de acesso e senha</p>
            </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Confirmar Senha *</label>
